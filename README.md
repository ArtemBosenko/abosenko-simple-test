...
Option|Links
-------|--------------------------
SHH|[git@github.com:ArtemBosenko/abosenko-simple-test.git](git@github.com:ArtemBosenko/abosenko-simple-test.git)
HTTPS|[https://github.com/ArtemBosenko/abosenko-simple-test.git](https://github.com/ArtemBosenko/abosenko-simple-test.git)
...
-------|--------------------------
Webserver|[localhost](http://localhost:8080)
